...
class MANGOS_DLL_SPEC PlayerbotPaladinAI : PlayerbotClassAI {
	...
	private:
		...
		// RET
		uint32 RETRIBUTION_AURA, SEAL_OF_COMMAND, JUDGEMENT_OF_LIGHT, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_MIGHT, BLESSING_OF_WISDOM, BLESSING_OF_MIGHT, HAMMER_OF_JUSTICE, RIGHTEOUS_FURY, CRUSADER_AURA, AVENGING_WRATH;
		...
		uint32 SpellSequence, LastSpellRet, LastSpellHolyp;
