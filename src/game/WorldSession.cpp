...
{
///////////////////////// Playerbotmod: send packet to bot AI /////////////////////////////////////////////////
    if (GetPlayer()) {
...
bool WorldSession::Update(uint32 /*diff*/)
{
 ...
 ///////////////////////// Playerbotmod: if this player has bots let the bot AI see the masters packet ///////////////////////////////
...
/////// Playerbotmod - Process player bot packets ///////////////////////////////////////////////////////////////////////////
    ...
    if (GetPlayer() && GetPlayer()->GetPlayerbotMgr()) {
                ...
                itr != GetPlayer()->GetPlayerbotMgr()->GetPlayerBotsEnd(); ++itr)
        {
            ...
            {
                while (pBotWorldSession->_recvQueue.next(packet) == true) // empty())) changes per xeqt from here
                {
...
void WorldSession::LogoutPlayer(bool Save)
{
    ...
    if (_player)
    {
////////// Playerbotmod: log out all player bots owned by this toon //////////////////////////////////////////////
...
//////////// Playerbotmod - remember player GUID for update SQL below ////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //No SQL injection as AccountId is uint32
        CharacterDatabase.PExecute("UPDATE characters SET online = 0 WHERE guid = '%u'", guid);//<---playerbotmod guid is added ///////////////////////////////////
          //GetAccountId()); //original line
