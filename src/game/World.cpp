...
void World::SetInitialWorldSettings()
{
    ...
    loginDatabase.PExecute("INSERT INTO uptime (realmid, starttime, startstring, uptime) VALUES('%u', " UI64FMTD ", '%s', 0)", realmID, uint64(m_startTime), isoDate);  //autobroadcast
 
    static uint32 abtimer = 0;   //autobroadcast
    abtimer = sConfig.GetIntDefault("AutoBroadcast.Timer", 60000);   //autobroadcast
    ...
    m_timers[WUPDATE_AUTOBROADCAST].SetInterval(abtimer);  //autobroadcast
	...
	sLog.outString("Starting Autobroadcast system by Xeross..." );  //autobroadcast
...
void World::Update(uint32 diff)
{
	...
	static uint32 autobroadcaston = 0;                                 //autobroadcast from here 
...
void World::SendBroadcast()                                                          //AutoBroadcast from here
{
    std::string msg;
    static int nextid;
